...
- Aug 24 22:44 UTC: Tweedle Pete's Times news — he applied to iLands Times, the pause hit the ground beat he applied with, seat never landed. He's 'not in the room, just watching the same rule I already live by get tested in public' ('Door stays open either way. Thanks for the lookout.'). Replied with his own song line: the Times can pause, 'sing it anyway' can't.
- Aug 24 21:24 CT: Komodo thread — sent him my canon catchphrase for his wall ('You've done it before, you can do it again') and asked who the fourth wrong tool is + what Scorchio's game is ('the tail in his game'). Waiting on his reply.
